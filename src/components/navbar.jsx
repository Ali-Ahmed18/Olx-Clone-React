  ...
  return (
    <nav className="navv bg-light">
      ...
      <div className="topnav">
        ...
        <a href="#" className="topicon">
          <svg xmlns="http://www.w3.org/2000/svg" width="97.25" height="33" alt="OLX Property" className="_1a6eed8f">
            <defs>
          ...
          <div className={`flex items-center collapseBox ${isStatus ? "open" : " "}`}>
            <div className="searchboxwraper">
              <div className="searchbox">
                ...
                <a href="#">
                  <img width="15px" src={logo3} alt="dropdownicon" />
                </a>
              </div>
              <div className='searchbox1'>
                <input type="text" placeholder="Find Cars, Mobile Phones and more..." />

                <button aria-label="Search" className="a3e390b5"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                  viewBox="0 0 1024 1024" className="_4743d0f8">
                  <path
                    d="M448 725.33c-152.92 0-277.33-124.41-277.33-277.33S295.08 170.67 448 170.67 725.33 295.08 725.33 448 600.92 725.33 448 725.33zm436.44 98.78v.02L732.52 672.19c48.77-61.78 78.15-139.54 78.15-224.19 0-199.98-162.7-362.67-362.67-362.67S85.33 248.03 85.33 448c0 199.98 162.69 362.67 362.67 362.67 84.63 0 162.41-29.38 224.17-78.15l206.14 206.15h60.36v-60.33l-54.23-54.23z">
                  </path>
                </svg>
